...
if you face audio issues like audio craking or noise do this "export PULSE_LATENCY_MSEC=60", this is not a problem of my build, this is a well known wine issue.
<h1>enjoy<h1/>
